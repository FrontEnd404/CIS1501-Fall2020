...
word_displayed = []
secret_word_list = []
word_displayed_after_user_guess = []
guessed_letters = []
user_guess = ""
wrong_guess = 0
keep_going = "yes"
display_blank_plus_user_letters = []
...
def let_user_guess():
    ...
    while keep_going == "yes":
        global user_guess
        user_guess = input("what letter do you want to guess?")
...
def put_secret_word_it_list_of_charters():
    for c in secret_word:
        secret_word_list.append(c)

def see_if_user_guess_is_in_secret_word_list():
    if user_guess in secret_word_list:
        print("good job that letter is in the word")
        print("this is the word so far")
        for r in secret_word_list:
            if user_guess == r :
                word_displayed.append(user_guess)
