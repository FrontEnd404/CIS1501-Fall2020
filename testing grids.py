...
def check_for_tie():
    global win
    if number_grid[0][0] !=0 and number_grid != [1][0] and  number_grid != [2][0] and number_grid != [3][0] and number_grid != [0][1] and number_grid != [1][1] and  number_grid != [2][1] and number_grid != [3][1] and number_grid != [0][2] and number_grid != [1][2] and  number_grid != [2][2] and number_grid != [3][2] and number_grid != [0][3] and number_grid != [1][3] and number_grid != [2][3] and number_grid != [3][3]:
